...
//        if ((message.getSendID()+"").equals(SendBird.getCurrentUser().getUserId())) {
...
//        }
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message) {
            ...
            nameText.setText(message.getSendID()+" ");

            // Insert the profile image from the URL into the ImageView.
            //ImageUtils.displayRoundImageFromUrl(mContext, message.getSendID().getProfileUrl(), profileImage);
        }
    }
}
