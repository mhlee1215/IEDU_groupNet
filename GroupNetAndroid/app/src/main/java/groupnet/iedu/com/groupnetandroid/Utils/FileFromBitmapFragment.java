...
public class FileFromBitmapFragment extends AsyncTask<Void, Integer, String> {
    File file;
    Fragment context;
    Bitmap bitmap;
    //String path_external = Environment.getExternalStorageDirectory() + File.separator + "temporary_file.jpg";

    public FileFromBitmapFragment(Bitmap bitmap, Fragment context) {
        this.bitmap = bitmap;
    ...
    protected String doInBackground(Void... params) {
        ...
        file = new File(context.getActivity().getCacheDir(), "tmp.jpg");
...
//            fo.close();
    ...
    protected void onPostExecute(String s) {
        ...
        if(file != null)
            ((AddFragment)context).uploadFile(file);
         //sendFile(file);
