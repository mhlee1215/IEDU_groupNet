...
public class BottomNav2Activity extends AppCompatActivity {
...
//    }
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                AHNotification notification = new AHNotification.Builder()
                        .setText(":)")
                        .setBackgroundColor(ContextCompat.getColor(BottomNav2Activity.this, R.color.color_notification_back))
                        .setTextColor(ContextCompat.getColor(BottomNav2Activity.this, R.color.color_notification_text))
                        .build();
     ...
     */
    public void reload() {
        startActivity(new Intent(this, BottomNav2Activity.class));
        finish();
    }
